...
valid_entrezIDs_down <- entrezIDs_down[entrezIDs_down %in% names(transcriptsBy(TxDb.Mmusculus.UCSC.mm10.knownGene, by = "gene"))]
transcriptCoordsByGene.GRangesList_down <-
   transcriptsBy (TxDb.Mmusculus.UCSC.mm10.knownGene, by = "gene")[valid_entrezIDs_down]
